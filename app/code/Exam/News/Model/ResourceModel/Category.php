...
use Exam\News\Model\Category as CategoryModel;
...
class Category extends AbstractResourceModel
{
    ...
    {
        $this->_init('news_blog_category', 'category_id');
    }
    ...
    {
        return $this->getStoreIds('news_blog_category_store', 'category_id', $id);
    }
    ...
    {
        $table = $this->getTable('news_blog_category_store');
    ...
    public function checkUrlKeyAndGetId($url_key)
    {
        ...
        return $this->getObjectIdByStore($categoryIds, 'news_blog_category_store', 'category_id');
    }
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        if (!$this->checkUniqueUrlKey($object, $existingIds, 'news_blog_category_store', 'category_id')) {
