...
use Exam\News\Api\Data\PostInterface;
...
class Post extends AbstractModel implements IdentityInterface, PostInterface
{
    ...
    const CACHE_TAG = 'news_blog_post';

    protected $_cacheTag = 'news_blog_post';

    protected $_eventObject = 'news_blog_post';

    protected $_eventPrefix = 'news_blog_post';
    ...
    {
        $this->_init('Exam\News\Model\ResourceModel\Post');
    }
