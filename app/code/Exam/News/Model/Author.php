...
use Exam\News\Api\Data\AuthorInterface;
...
{
    const CACHE_TAG = 'news_blog_author';

    protected $_cacheTag = 'news_blog_author';

    protected $_eventObject = 'news_blog_author';

    protected $_eventPrefix = 'news_blog_author';
    ...
    {
        $this->_init('Exam\News\Model\ResourceModel\Author');
    }
