...
use Exam\News\Api\Data\CategoryInterface;
...
class Category extends AbstractModel implements IdentityInterface, CategoryInterface
{
    ...
    const CACHE_TAG = 'news_blog_category';

    protected $_cacheTag = 'news_blog_category';

    protected $_eventObject = 'news_blog_category';

    protected $_eventPrefix = 'news_blog_category';
    ...
    {
        $this->_init('Exam\News\Model\ResourceModel\Category');
    }
    ...
    public function getCategoryUrl()
    {
        ...
        $postUrl = (!empty($prefixUrl)) ? '/' . $prefixUrl . '/' . $urlKey : '/news_blog' . '/' . $urlKey;
        return $postUrl;
    }
