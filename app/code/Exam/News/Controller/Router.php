...
namespace Exam\News\Controller;

use Exam\News\Model\AuthorFactory;
use Exam\News\Model\CategoryFactory;
use Exam\News\Model\Config\Config;
use Exam\News\Model\PostFactory;
use Exam\News\Model\TagFactory;
    ...
    public function match(RequestInterface $request)
    {
        ...
        if ($urlKey) {
            if ($explodedIdentifier[0] == $urlKey && !isset($explodedIdentifier[1])) {
                $request->setModuleName('news_blog');
            ...
            if ($explodedIdentifier[0] == $urlKey || $explodedIdentifier[0] == 'news_blog') {
                if (!empty($postId)) {
                    $request->setModuleName('news_blog');
